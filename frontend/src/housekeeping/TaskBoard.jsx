...
const TaskBoard = () => {
	...
	return (<div className="manager-container page-fade-in">
		...
		<div className="task-list">
			{tasks.length === 0 && !error ? (<div className="glass-card no-results">
				<p>All caught up! No pending tasks. ✨</p>
			</div>) : (tasks.map(task => (<div key={task.taskID} className="glass-card task-item">
				<div className="task-info">
					...
					{task.notes && (<div className="task-notes-box">
