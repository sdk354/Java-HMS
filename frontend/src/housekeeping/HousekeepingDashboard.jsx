...
const HousekeepingDashboard = () => {
	const [stats, setStats] = useState({
		pendingTasks: 0, maintenanceRooms: 0, staffOnDuty: 0, progressPercentage: 0
	});
	...
	if (loading) return (<div className="hk-dashboard">
		<div className="glass-card p-10 text-center">Loading Dashboard Data...</div>
	</div>);

	if (error) return (<div className="hk-dashboard">
	...
	return (<div className="hk-dashboard page-fade-in">
