...
const MyReservations = ({user}) => {
	...
	if (loading) {
		return (<div className="my-res-container">
	...
	return (<div className="my-res-container page-fade-in">
		...
		<div className="res-list">
			{bookings.length > 0 ? (bookings.map((res, index) => {
				const uniqueId = res.bookingId || res.reservationID || res.id || index;

				return (<div key={uniqueId} className="glass-card res-item">
