...
const BrowseRooms = () => {
	...
	const handleBookClick = (room) => {
		// We pass the room object via the 'state' property of navigate
	...
	const filteredRooms = floorFilter !== ""
		? rooms.filter(room => room.floorNumber.toString() === floorFilter.toString())
		: rooms;

	if (loading) return <div className="rooms-container">Searching for available rooms...</div>;

	return (
		<div className="rooms-container page-fade-in">
