...
const DynamicPricing = () => {
	...
	// Schema: pricingID, roomTypeID, startDate, endDate, pricingMultiplier, seasonName
	...
	const handleOpenEdit = (rule) => {
		setIsEditing(true);
		// Ensure data maps correctly to form fields
		setFormData({
			pricingID: rule.pricingID,
			roomTypeID: rule.roomType?.typeID || rule.roomTypeID, // Handle both flat and nested objects
				...
				<div className="glass-card pricing-rules-card">
					...
					<div className="rules-list">
						{pricingRules.map((rule) => (
							<div key={rule.pricingID} className="rule-item">
                            ...
                            <span className="rule-type-badge">
								...
								<div className="rule-impact-group">
									...
									<div className="rule-actions">
										...
										<button className="icon-btn delete" onClick={() => handleDelete(rule.pricingID)}>
											<FaTrash />
										</button>
									</div>
								</div>
				...
				<div className="glass-card calculator-card">
					...
					<div className="calc-preview">
						...
						{pricingRules.slice(0, 3).map(rule => (
							<div key={rule.pricingID} className="calc-row highlighted">
						...
						<form onSubmit={handleSubmit}>
							...
							<div className="form-group">
								...
								<input
									...
									onChange={e => setFormData({...formData, pricingMultiplier: parseFloat(e.target.value)})}
								/>
							</div>
